...
export const CommonSchemas = {
    ...
    /** Maximum token count */
    maxTokens: z.number().int().min(1).max(4096, 'Max tokens must be between 1 and 4096')
};
/**
 ...
 */
export const validator = RuntimeValidator;
/**
 * Convenient validation functions
 */
export const validate = RuntimeValidator.validate.bind(RuntimeValidator);
export const safeValidate = RuntimeValidator.safeValidate.bind(RuntimeValidator);
